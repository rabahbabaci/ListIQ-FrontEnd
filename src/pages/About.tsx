...
const About = () => (
  <div className="min-h-screen bg-[#FAFAF8] pt-24 pb-12">
    <div className="max-w-[1200px] mx-auto px-6 md:px-12">
      <h1 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 text-center mb-12">About ListIQ</h1>

      <HowItWorksDetail />

      <section className="mb-16 max-w-3xl mx-auto">
        <h2 className="font-serif text-2xl font-bold text-gray-900 text-center mb-6">Our Data</h2>
